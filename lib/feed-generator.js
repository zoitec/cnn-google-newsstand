        ...
        return new Promise((resolve) => {
            ...
            contentModels.forEach((contentModel) => {
                ...
                if (contentModel.docs[0].type === 'article') {
                    ...
                    feed += `<meta itemprop="headline" content="${contentModel.docs[0].headline.trim()} 1"/>`; // TODO escape quotes - maybe
