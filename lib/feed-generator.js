...
class FeedGenerator {
    ...
    set urls(urls) {
        ...
        uniqueFilteredUrls = Array.from(new Set(filteredUrls));

        this._urls = (this._urls) ? this._urls.push(uniqueFilteredUrls) : uniqueFilteredUrls;
    }
    ...
    generateFeed(contentModels) {
        ...
        return new Promise((resolve) => {
            ...
            contentModels.forEach((contentModel) => {
                ...
                feed += '<item>';
                feed += `<title>${contentModel.docs[0].headline.trim()} - 1</title>`;
                ...
                contentModel.docs[0].relatedMedia.media.forEach(function (item) {
                    let imageCut = '';
