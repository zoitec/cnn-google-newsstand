                            ...
                            if (item.type === 'reference') {
                                ...
                                if (config.get('gnsEnableInlineGalleries') === true || config.get('gnsEnableInlineGalleries') === 'true') {
                                    ...
                                    if (item.referenceType === 'gallery') {
                                        ...
                                        if (item.slides) {
                                            feedItem += '<section class="type:slideshow">';
                                            item.slides.forEach(function (slide) {
                                                ...
                                                if (slide && slide.cuts) {
                                                    ...
                                                    feedItem += '<figure>';
                                                    feedItem += `<img src="${slide.cuts[galleryImageCut].url.replace(/i2.cdn.turner.com\/cnnnext\/dam\/assets\//, 'dynaimage.cdn.turner.com/gns/gns/e_trim/').replace(/\-super\-169/, '').replace(/-live-video/, '')}"/>`;
                                                    ...
                                                    if (slide.caption) {
                                                        ...
                                                        if (galleryImageCutCaption) {
                                                            feedItem += `<p class="style-id:caption"><q class="style-id:caption">${galleryImageCutCaption}</q></p>`;
                                                        }
