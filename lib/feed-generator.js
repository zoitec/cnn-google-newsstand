                ...
                if (contentModel.docs[0].type === 'article') {
                    ...
                    if (contentModel.docs[0].body.notes && contentModel.docs[0].body.notes.www) {
                        if (typeof contentModel.docs[0].body.notes.www === 'string') {
                            feed += `<p class="style-id:editorsNote"><em class="style-id:editorsNote"><strong>Editor's Note:</strong> ${contentModel.docs[0].body.notes.www.trim()}</em></p>`;
                        }
                    }
                    ...
                    contentModel.docs[0].body.paragraphs.forEach(function (paragraph) {
                        if (typeof paragraph.richtext === 'string') {
                            ...
                            if (paragraph.richtext.startsWith('<h3>')) {
                                ...
                                if (firstParagraph) {
                                    feed += `<p class="style-id:firstParagraph"><span class="style-id:firstParagaphText">${paragraph.richtext.trim()}</span></p>`;
                        ...
                        if (paragraph.elements.length > 0) {
                            ...
                            //         // case 'twitter':
                            //             // need to hand construct and style, which may be a challenge
                            //
                            //         // case 'facebook':
                            ...
                            //             // - ask Google about the height and width values (we got those from them)
                            ...
                            if (paragraph.elements[0].type === 'handle') {
                                ...
                                if (paragraph.elements[0].target.type === 'video') {
                                    contentModel.docs[0].relatedMedia.media.some((item) => {
                                        ...
                                        //
                                        //     if (!item.title && !description && item.source) {
                                        //         caption = `<span class="style-id:credit">${item.source}</span>`;
                                        //     }
                                        //
                                        //     if (item.title && !description && item.source) {
                                        //         caption = `${item.title} <span class="style-id:credit">${item.source}</span>`;
                                        //     }
                                        //
                                        //     if (!item.title && description && item.source) {
                                        //         caption = `${description} <span class="style-id:credit">${item.source}</span>`;
                                        //     }
                                        //
                                        //     if (item.title && description && item.source) {
                                        //         caption = `${item.title} - ${description} <span class="style-id:credit">${item.source}</span>`;
                                        //     }
                                        //
                                        //     if (caption) {
                    ...
                    feed += `<div class="style-id:footer"><span class="style-id:copyright">&copy;${new Date().getFullYear()} Cable News Network, Inc. A Time Warner Company. All Rights Reserved.</span></div>`;
...
//         type: 'instagram',
//         url: '<blockquote class="style-id:instagram-media" data-instgrm-captioned data-instgrm-version="5" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">\
...
//             type: 'twitter',
//             url: '<blockquote class="style-id:twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Gabby Douglas&#39; mom: &quot;She was devastated&quot; by the online bullying <a href="https://twitter.com/hashtag/Rio2016?src=hash">#Rio2016</a> <a href="https://t.co/IVmFOkSGQ0">https://t.co/IVmFOkSGQ0</a></p>&mdash; New Day (@NewDay) <a href="https://twitter.com/NewDay/status/765156947129667584">August 15, 2016</a></blockquote>\n<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>',
//             embedStrategy: 'legacy'
//         }
//     },
//     mock2 = {
...
//             type: 'twitter',
//             url: '<blockquote class="style-id:twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Yo I just heard Gabby getting attacked on her page show her the love you showed me <a href="https://twitter.com/hashtag/LOVE4GABBYUSA?src=hash">#LOVE4GABBYUSA</a> send to <a href="https://twitter.com/gabrielledoug">@gabrielledoug</a></p>&mdash; Leslie Jones (@Lesdoggg) <a href="https://twitter.com/Lesdoggg/status/765052419709476865">August 15, 2016</a></blockquote>\n<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>',
//             embedStrategy: 'legacy'
//         }
//     },
//     mock3 = {
...
//             type: 'twitter',
//             url: '<blockquote class="style-id:twitter-tweet" data-lang="en"><p lang="en" dir="ltr">2016 may not be 2012 but <a href="https://twitter.com/gabrielledoug">@gabrielledoug</a> is an astoundingly great gymnast and <a href="https://twitter.com/hashtag/BeKindChampion?src=hash">#BeKindChampion</a> <a href="https://twitter.com/hashtag/LOVE4GABBYUSA?src=hash">#LOVE4GABBYUSA</a> <a href="https://t.co/rcUm9QF7Ak">pic.twitter.com/rcUm9QF7Ak</a></p>&mdash; BeKindCocopah (@BeKindCocopah) <a href="https://twitter.com/BeKindCocopah/status/765168967652519936">August 15, 2016</a></blockquote>\n<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>',
//             embedStrategy: 'legacy'
//         }
//     },
//     mock4 = {
...
//             type: 'twitter',
//             url: '<blockquote class="style-id:twitter-tweet" data-lang="en"><p lang="en" dir="ltr">So much <a href="https://twitter.com/hashtag/LOVE4GABBYUSA?src=hash">#LOVE4GABBYUSA</a>...not many people can do what she does ⭐️ <a href="https://t.co/gM0NeWxvps">pic.twitter.com/gM0NeWxvps</a></p>&mdash; Ali Benveniste (@apbenven) <a href="https://twitter.com/apbenven/status/765196624436064256">August 15, 2016</a></blockquote>\n<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>',
//             embedStrategy: 'legacy'
//         }
//     };
